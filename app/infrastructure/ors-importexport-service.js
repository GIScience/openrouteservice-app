 ...
 **/.factory("orsExportFactory", [
    ...
    "orsUtilsService",
    "orsRouteService",
    (FileSaver, Blob, orsNamespaces, orsRequestService, orsSettingsFactory, orsUtilsService, orsRouteService) => {
                    ...
                    if (geomType == "linestring") {
                        ...
                        for (let i = 0; i < geometry.length; i++) {
                            ...
                            const geojsonpolygon = {
                                type: "Feature", properties: properties, geometry: {
