angular.module('orsApp.apikey-factory', [])
    .factory('orsApikeyFactory', ['$timeout', '$interval', '$injector', ($timeout, $interval, $injector) => {
        ...
        orsApikeyFactory.setApiKeyInterval = () => {
            ...
            $interval(function() {
                return httpService.get("weathercheck.txt")
