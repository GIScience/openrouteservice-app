angular.module('orsApp.params-service', [])
    .factory('orsParamsService', ['orsUtilsService', 'orsObjectsFactory', 'orsRequestService', 'orsMapFactory', 'lists', (orsUtilsService, orsObjectsFactory, orsRequestService, orsMapFactory, lists) => {
