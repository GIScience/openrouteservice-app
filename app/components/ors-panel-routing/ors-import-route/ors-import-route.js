angular
  .module("orsApp.ors-importRoute-controls", [])
  .component("orsImportRouteControls", {
    templateUrl:
      "components/ors-panel-routing/ors-import-route/import_route_tpl.html",
    controller: [
      "$scope",
      "orsImportFactory",
      "orsObjectsFactory",
      ...
      function(
          ...
          function setupReader(file) {
            ...
            reader.onload = function(e) {
              onLoadHandler(
                ...
                processedCount,
                uploadedFiles
              ); //this will happen during the onload event
        ...
        ctrl.previewRoute = file => {
          if (file.preview) {
            ...
            let action_removeLayer = orsObjectsFactory.createMapAction(
              2,
              lists.layers[4],
              undefined,
              file.index
        ...
        ctrl.importRoute = file => {
          ...
          for (let coord of linestring.geometry.coordinates) {
            ...
            const wpObj = orsObjectsFactory.createWaypoint(
              latLngString,
              latLng,
              1
            );
