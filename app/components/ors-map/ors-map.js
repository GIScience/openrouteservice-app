            ...
            (
                ...
                $scope.$on("changeOptions", (func, payload) => {
                    ...
                    if (setting === "heightgraph") {
                        if (options.showHeightgraph) {
                            ...
                            if (
                                Object.keys(
                                    $scope.mapModel.geofeatures.layerRouteLines[
                                        "_layers"
                                    ]
                                ).length !== undefined &&
                                orsSettingsFactory.ngRouteSubject.getValue() ===
                                    "directions"
                            ) {
                                $scope.hg.options.expand =
                                ...
                                if (
                                    ...
                                    angular.isDefined(
                                        orsRouteService.data.routes
                                    )
                                ) {
                                    if (
                                        orsRouteService.data.routes.length > 0
                                    ) {
                ...
                L.FullwidthControl = L.Control.extend({
                    ...
                    onAdd: function(map) {
                        ...
                        L.DomEvent.on(link, "click", L.DomEvent.stop).on(
                            ...
                            "click",
                            function() {
                                let orsLeft = document.getElementsByClassName(
                                    "ors-left"
                                );
                ...
                orsSettingsFactory.userOptionsSubject.subscribe(settings => {
                    if (settings.language) {
                        $scope.mapModel.map.removeControl(
                            $scope.measureControl
                        );
                ...
                let mapInitSubject = orsSettingsFactory.mapOptionsInitSubject.subscribe(
                    settings => {
                        ...
                        $scope.showHeightgraph = angular.isDefined(
                        ...
                        if (settings.lat && settings.lng && settings.zoom) {
                            ...
                            if (orsCookiesFactory.getMapOptions()) {
                                ...
                                $scope.welcomeMsgBox.onAdd = function(map) {
                                    var div = $compile(
                                        "<ors-welcome-box></ors-welcome-box>"
                                    )($scope)[0];
                                    return div;
                                };
                                $timeout(function() {
                                    if (!$scope.smallScreen)
                                        $scope.mapModel.map.addControl(
                                            $scope.welcomeMsgBox
                                        );
                                }, 500);
                            }
                ...
                $scope.signupBox.onAdd = function(map) {
                    var div = $compile("<ors-signup-box></ors-signup-box>")(
                        $scope
                    )[0];
                    return div;
                };
                ...
                const deleteShape = function(e) {
                    if (
                        ...
                        if (
                            $scope.geofeatures.layerAvoid.getLayers().length ===
                            0
                        )
                            $scope.layerControls.removeLayer(
                ...
                $scope.mapModel.map.on("load", evt => {
                    ...
                    $scope.mapModel.geofeatures.layerAvoid.addTo(
                        $scope.mapModel.map
                    );
                    ...
                    $scope.mapModel.geofeatures.layerEmph.addTo(
                        $scope.mapModel.map
                    );
                    $scope.mapModel.geofeatures.layerTracks.addTo(
                        $scope.mapModel.map
                    );
                    $scope.mapModel.geofeatures.layerRouteExtras.addTo(
                        $scope.mapModel.map
                    );
                    $scope.mapModel.geofeatures.layerLocations.addTo(
                        $scope.mapModel.map
                    );
                    $scope.mapModel.geofeatures.layerRouteDrag.addTo(
                        $scope.mapModel.map
                    );
                    $scope.mapModel.geofeatures.layerLandmarks.addTo(
                        $scope.mapModel.map
                    );
                    ...
                    $scope.mapModel.geofeatures.layerAvoid.on(
                        "layeradd",
                        function(e) {
                ...
                $scope.mapModel.map.on("zoomend", e => {
                    ...
                    if (currentZoom >= 15) {
                        d3.select(
                            $scope.mapModel.map.getPanes().overlayPane
                        ).style("opacity", 0.5);
                    } else {
                        d3.select(
                            $scope.mapModel.map.getPanes().overlayPane
                ...
                $scope.addWaypoint = (
                    ...
                    wayPointMarker.addTo(
                        $scope.mapModel.geofeatures.layerRoutePoints
                    );
                    ...
                    if (typeof actionPackage != "undefined") {
                        if (typeof actionPackage.featureId != "undefined") {
                            ...
                            if (actionPackage.geometry !== undefined) {
                                if (
                                    actionPackage.geometry.lat &&
                                    actionPackage.geometry.lng
                                ) {
                                    $timeout(function() {
                                        $scope.mapModel.map.panTo(
                                ...
                                $scope.orsMap.fitBounds(
                                    new L.featureGroup(
                                        Object.keys(
                                            ...
                                            return $scope.mapModel.geofeatures[
                                                key
                                            ];
                                        })
                                    ).getBounds()
                        ...
                        $scope.orsMap.fitBounds(
                            new L.featureGroup(
                                Object.keys($scope.mapModel.geofeatures).map(
                                    key => {
                ...
                $scope.addLocations = actionPackage => {
                    ...
                    const onEachFeature = (feature, layer) => {
                        ...
                        // use category_name with space instead of underscore if no name tag available
                            ...
                            let noUnderscoreName = cIds[
                                Object.keys(cIds)[0]
                            ].category_name
                                .split("_")
                                .join(" ");
                            popupContent +=
                                "<strong>" + noUnderscoreName + "</strong>";
                            feature.properties[
                                "noUnderscoreName"
                            ] = noUnderscoreName;
                        }
                        ...
                        if (feature.properties["osm_tags"].address) {
                            ...
                            if (feature.properties["osm_tags"].address.street)
                                popupContent +=
                                    feature.properties["osm_tags"].address
                                        .street + ", ";
                            if (
                                feature.properties["osm_tags"].address
                                    .house_number
                        ...
                        if (feature.properties["osm_tags"].wheelchair)
                            popupContent +=
                                "<br>" + lists.locations_icons.wheelchair;
                        ...
                        popupContent +=
                            "<br>Source: © OpenStreetMap-Contributors";
                            ...
                            locationsIcon.options.html =
                                lists.locations_icons[
                                    $scope.subcategoriesLookup[
                                        parseInt(
                                            Object.keys(
                                                feature.properties.category_ids
                                            )
                                        )
                                    ]
                                ];
                ...
                $scope.addFeatures = actionPackage => {
                    const isDistanceMarkers =
                        orsSettingsFactory.getUserOptions().distanceMarkers ===
                        true;
                ...
                */
                $scope.locateOnLineCopiedFromGeometryUtil = (
                    map,
                    polyline,
                    latlng
                ) => {
                ...
                $scope.addPolylineHover = actionPackage => {
                    ...
                    $scope.pointList =
                        actionPackage.extraInformation.pointInformation;
                ...
                $scope.addHoverPoint = (
                    ...
                    $scope.hoverPoint = new L.marker(snappedPosition.latlng, {
                        ...
                        .on("dragend", event => {
                            $scope.processMapWaypoint(
                                pointList[snappedPosition.index].segment_index +
                                    1,
                        ...
                        .on("click", e => {
                            ...
                            $scope.interpolatedRoutePoint =
                                pointList[snappedPosition.index];
                            const popupDirective =
                                "<ors-route-point-popup></ors-route-point-popup>";
                            const popupContent = $compile(popupDirective)(
                                $scope
                            );
                            $scope.pointPopup
                                .setContent(popupContent[0])
                ...
                $scope.toggleIsochronesMarker = actionPackage => {
                    ...
                    if (toggle)
                        angular.element(marker._icon).addClass("hideMarker");
                    else
                        angular.element(marker._icon).removeClass("hideMarker");
                };
                ...
                $scope.clear = actionPackage => {
                    if (!(actionPackage.featureId === undefined)) {
                        $scope.mapModel.geofeatures[
                            ...
                            if (
                                layer.options.index == actionPackage.featureId
                            ) {
                                $scope.mapModel.geofeatures[
                                    actionPackage.layerCode
                                ].removeLayer(layer);
                ...
                $scope.hereControl.onAdd = map => {
                    let div = $compile("<ors-here-popup></ors-here-popup>")(
                        $scope
                    )[0];
                    ...
                    request.promise.then(
                        data => {
                            ...
                            if (data.features.length > 0) {
                                ...
                                $scope.address.info = {
                                    processed: {
                                        primary: $scope.translateFilter(
                                            "NO_ADDRESS"
                                        )
                                    }
                                };
                            }
                            $scope.address.position =
                                "<small>" + latLngString + "</small>";
                        ...
                        response => {
                            orsMessagingService.messageSubject.onNext(
                                lists.errors.GEOCODE
                            );
                        }
                    );
                };
                    ...
                    return L.control.angular({
                     ...
                     `,
                        ...
                        controller: function(
                            ...
                            $scope.makeUrl = osmId => {
                                return (
                                    "http://www.openstreetmap.org/node/" + osmId
                                );
                            };
                            ...
                            $scope.callLocations = () => {
                                ...
                                const payload = orsUtilsService.locationsPayload(
                                    settings
                                );
                                const request = orsLocationsService.fetchLocations(
                                    payload
                                );
                                orsLocationsService.requests.push(request);
                                request.promise.then(
                                    function(response) {
                                        orsLocationsService.addLocationsToMap(
                                            response
                                        );
                            ...
                            $scope.verifySubcategory = selectedCategoryId => {
                                let cnt = 0;
                                angular.forEach(
                                    $scope.categories[selectedCategoryId]
                                        .subCategories,
...
angular.module("orsApp").directive("orsPopup", [
    ...
    (
        ...
        return {
            restrict: "E",
            templateUrl:
                "components/ors-map/directive-templates/ors-popup.html",
...
angular.module("orsApp").directive("orsAaPopup", [
    ...
    ($compile, $timeout, orsSettingsFactory) => {
        return {
            restrict: "E",
            templateUrl:
                "components/ors-map/directive-templates/ors-aa-popup.html",
            link: (scope, elem, attr) => {
                scope.add = idx => {
...
angular.module("orsApp").directive("orsHerePopup", [
    ...
    $translate => {
        return {
            restrict: "E",
            templateUrl:
                "components/ors-map/directive-templates/ors-here-popup.html",
            link: (scope, elem, attr) => {
                scope.hereShow = true;
            }
        };
