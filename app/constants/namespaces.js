...
angular.module("orsApp").constant("orsNamespaces", {
    ...
    layerHs: "https://korona.geog.uni-heidelberg.de/tiles/asterh/x={x}&y={y}&z={z}", //url to OSM layer
    layerBkgTopPlus: {
        ...
        options: {
            normal: {
                layers: "web",
                format: "image/png",
                attribution: "© <a href=\"http://www.bkg.bund.de\">Bundesamt für Kartographie und Geodäsie</a> 2020, <a href=\"https://sgx.geodatenzentrum.de/web_public/Datenquellen_TopPlus_Open.pdf\">Datenquellen</a>",
                id: 1
            }, grey: {
                layers: "web_grau",
                format: "image/png",
    ...
    layerStamen: {
        url: "http://{s}.tile.stamen.com/toner/{z}/{x}/{y}.png", options: {
            attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/copyright\">OpenStreetMap</a> contributors"
        }
    }, overlayHillshade: {
        url: "https://korona.geog.uni-heidelberg.de/tiles/asterh/x={x}&y={y}&z={z}", options: {}
    }, layerWorldImagery: {
        url: "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}", options: {
            attribution: "Tiles &copy; Esri &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community",
            id: 7
        }
    }, layerCycleOsm: {
        url: "https://{s}.tile-cyclosm.openstreetmap.fr/cyclosm/{z}/{x}/{y}.png", options: {
            attribution: "Tiles <a href=\"https://github.com/cyclosm/cyclosm-cartocss-style/releases\">CycleOSM</a> latest",
            id: 8
        }
    }
})
