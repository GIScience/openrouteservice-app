var $__app_47_scripts_47_components_47_ors_45_panel_45_routing_47_ors_45_instructions_47_ors_45_export_45_route_47_ors_45_export_45_route_46_js__ = (function() {
  "use strict";
  var __moduleName = "app/scripts/components/ors-panel-routing/ors-instructions/ors-export-route/ors-export-route.js";
  angular.module('orsApp.ors-exportRoute-controls', []).component('orsExportRouteControls', {
    templateUrl: 'scripts/components/ors-panel-routing/ors-instructions/ors-export-route/ors-export-route.html',
    controller: ['orsExportFactory', 'orsRouteService', function(orsExportFactory, orsRouteService) {
      ...
      ctrl.current_gpxOpt1 = ctrl.selected_gpxOpt1.value;
      ctrl.current_gpxOpt2 = ctrl.selected_gpxOpt2.value;
      ...
      ctrl.exportRoute = function() {
        ...
        var currentRoute = orsRouteService.routeObj.routes[orsRouteService.getCurrentRouteIdx()].points;
